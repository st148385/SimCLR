...
@gin.configurable('classifierHead')
def Architecture_classifierHead(mlp_dense1=512, mlp_dense2=128, input_dim=128):
    ...
    g_a = tf.keras.layers.Dense(10, name="Classification_Layer_for_cifar10-classification")(g_a)
